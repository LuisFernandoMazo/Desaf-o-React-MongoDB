import { PriceSpecial } from "./../models/PriceSpecial.js";
...
export const addNewPriceSpecial = async ({ userId, productId, specialPrice, startDate, endDate, createAt, updateLastAt, status, }) => {
    try {
        ...
        throw new Error(error.message || "Error desconocido al guardar la información");
    }
};
...
export const findIdAndUpdate = async (id, updates) => {
    try {
